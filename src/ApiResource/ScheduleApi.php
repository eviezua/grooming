...
#[ApiResource(
    ...
    operations: [
        ...
        new Post(securityPostDenormalize: "is_granted('SCHEDULE_CREATE', object)"),
        new Put(securityPostDenormalize: "is_granted('SCHEDULE_EDIT', object)"),
        new Patch(securityPostDenormalize: "is_granted('SCHEDULE_EDIT', object)"),
        new Delete(security: "is_granted('SCHEDULE_DELETE', object)"),
    ],
